...
plus ``tables`` (what each table is, where it came from, row count, file hash) into
``data/auto/tradeimpact_auto.sqlite``. Table names are the CSV file stems. Column types are
