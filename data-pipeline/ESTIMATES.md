...
| Fleet base intensity I_fleet(0) | JP 0.150, EU 0.140, AU 0.185, KR 0.165, US 0.200 kgCO₂e/km | In-use all-vintage fleet average: EU cleanest (diesel/small cars), AU/US ute/truck-heavy | C |
| Annual distance D_c | JP 9,500; EU 12,000; AU 13,800; KR 13,000; US 18,000 km/yr | National VKT statistics magnitudes (MLIT, EEA, BITRE, KTDB, FHWA) | B/C |
...
- **Markets:** KR, JP, EU, AU (computed S2 benchmarks) + US (FLAG — S1/S3 only). China
  omitted: FLAG_PEAK benchmark **and** unreliable rough volume splits; add when
