...
|---|---|---|---|---|
| [ST01 targets](stages/st01-targets-and-provenance.md) | PH1, PH4 | Done for the built markets — `target_set.csv` written by `build_target_set.py`, all four §6.3 criteria evaluated per target and the failures recorded rather than dropped: §6.3-2 (70 % of worldwide sales) fails for all four firms at 32-58 %, §6.3-4(c) (an accessible registration database) fails in the US and Korea, §6.3-3 (grid spread) is met in 2024 and fails in 2025. `B-03` still open | `target_set.csv` (44) | `[compute]` |
| [ST02 `sales`](stages/st02-06-datasets.md) | PH1, PH4 | EU27 complete for the four exporters in scope; US and Korea built from the companies' own market-side releases, all now on fetch routes rather than hand-gathered files (Kia IR's listing endpoint added 2026-09-11, giving Korea a Kia cohort for 2024, 2025 and 2026); AU still deferred | `sales_eea_eu27_2024.csv` (2,130), `sales_kia_ir_2024.csv` (287), `sales_kia_ir_2025.csv` (314), `sales_kia_ir_2026.csv` (290), `sales_hyundai_kr.csv` (154), `sales_hyundai_us.csv` (41), `sales_kia_us.csv` (23), `sales_toyota_us.csv` (110), `sales_nissan_us.csv` (42), `sales_jada_jp.csv` (42), `sales_hyundai_plant_2025.csv` (113) | `[compute]` |
