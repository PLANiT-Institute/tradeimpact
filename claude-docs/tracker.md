...
| [ST03 `country_emissions`](stages/st02-06-datasets.md) | PH1, PH4 | EU27 done from direct Eurostat/OWID fetches; US car CO2 (EPA, level and annual series) and grid done; AU grid done, AU passenger-car CO2 blocked (DCCEEW refuses automated access) | `country_emissions_eu27.csv` (1,312), `country_emissions_us.csv` (21), `country_emissions_owid_grid.csv` (52) | `[compute]` |
| [ST04 `emission_targets`](stages/st02-06-datasets.md) | PH1, PH2, PH4 | EU27 done (S2 power floored at the S1 trend where the target is met); US done (S1 observed, S2 FLAG, S3 world-NZE pro-rata); AU anchor transcribed, unverified | `emission_targets_eu27.csv` (162), `emission_targets_us.csv` (6) | `[compute]` |
