...
| ST02b `trade_flows` | PH1, PH4 | New 2026-09-04: EU27 imports from KR/JP (Comext) and both sides of KR/JP → US/AU flows (Comtrade), 2022–2025, by HS sub-heading → powertrain class; country-level bound on production origin and the only free coverage of Japan and Australia | `trade_flows.csv` (2,457) | `[compute]` |
